...
@Component({
  selector: 'app-doc-patient-records',
  templateUrl: './doc-patient-records.component.html',
  styleUrls: ['./doc-patient-records.component.css']
})
export class DocPatientRecordsComponent implements OnInit {
  ...
  doctorList: Doctor[] = [];
  hideprics = 1;
  constructor(private db: AngularFirestore, public appUserConfig: AppUserConfig) { }
  ...
  getAppointmentDetails() {
    ...
    this.db.collection(
      "Appointments",
      ref => ref.where("doctorId", "==", this.appUserConfig.id)
